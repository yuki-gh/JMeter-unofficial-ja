...
build:
	...
	native2ascii -encoding utf8 ja/ConstantThroughputTimerResources_ja.properties $(TIMER_PATH)/ConstantThroughputTimerResources_ja.properties
	...
	zip -u $(JMETER_COMP_JAR) $(TIMER_PATH)/ConstantThroughputTimerResources_ja.properties
